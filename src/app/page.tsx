        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 stagger-fade-in">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-8 shadow-lg hover-lift">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-green-700 dark:text-green-300">Health Dashboard</h2>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Our health dashboard helps you track your daily health metrics, get personalized insights, and stay informed about regional health trends.
            </p>
            <button 
              onClick={handleExploreHealth}
              className="inline-block bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
            >
              <div className="flex items-center">
                <span>Explore Health Features</span>
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </div>
